var BuildmSchema = module.exports = function() {
  this._attributeInfo = this._buildAttributeInfo(schema);
};

BuildmSchema.prototype.getAttributeInfo = function() {
  return this._attributeInfo;
};

BuildmSchema.prototype._buildAttributeInfo = function(schema) {
  var schemaInfo = {
    digitalObject: {},
    physicalAsset: {}
  };
